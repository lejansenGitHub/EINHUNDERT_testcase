...
class Invoice(models.Model):
    ...
    file_name           = models.CharField("Rechnungsname", max_length=256, default="123123")
    ...
    period_start        = models.DateField("Abrechnungsperiode von", default=datetime.date.today)
    period_end          = models.DateField("Abrechnungsperiode bis", default=datetime.date.today)
