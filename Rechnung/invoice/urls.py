...
from invoice.views import InvoiceViewSetList, InvoiceViewSetDetail, ContractViewSet, UserViewSet, api_root
from rest_framework import renderers
 
invoice_list = InvoiceViewSetList.as_view({
    'get': 'list',
    'post': 'postCustom'
})

invoice_detail = InvoiceViewSetDetail.as_view({
    'get': 'retrieve',
